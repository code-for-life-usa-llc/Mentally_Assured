...
def main():
    ...
    print (f"Hello!{name}")
    question1 = input(" would you care to join me in a conversation").upper()
    ...
    print ("..........")
    exit = ("well I have to go now Goodbye! it was nice getting to know you")
    print(exit)
    print ("..........")
    main()